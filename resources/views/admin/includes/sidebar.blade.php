<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li> 
                    <a href="{{ route('admin.testimonials.index')}}"><i class="bx bx-right-arrow-alt"></i>List</a>
                </li>
                <li> 
                    <a href="{{ route('admin.testimonials.create')}}"><i class="bx bx-right-arrow-alt"></i>Create</a>
                </li>
            </ul>
        </li>
        <li>
